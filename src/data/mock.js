...
export const SUB_FILTERS = [
  ...
  { id: 'no_allergy', tag: '알레르기 제외', label: '알레르기 제외', hint: '선택 성분 차단' },
]
...
export const HERO_SLIDES = [
  ...
  },
  {
    ...
    title: '속 편한 분리유청,\n당류 0g의 단백질 밸런스',
    desc: '유당 걱정 없는 깨끗한 단백질. 자연 감미료 알룰로스로 건강한 달콤함을 설계했습니다.',
    badge: '베스트셀러 기획전',
    btn: '고단백 클린식단 보기',
    goal: '근육량 증가',
    image:
  ...
  },
  {
    ...
    title: '설탕 없이도\n깊고 상쾌한 웰빙 라이프',
    desc: '탄산음료 대신 천연 발효 콤부차로 장 건강과 수분 리듬을 편안하게 깨워보세요.',
    badge: '無합성감미료 원칙',
    btn: '저당 웰빙 음료 보기',
    goal: '체중 관리',
    image:
