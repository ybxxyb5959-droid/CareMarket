export const ROUTINE_SLOTS = [
  { id: 'morning', time: '08:00', minute: 0, label: '아침', note: '하루를 여는 한 끼', categories: ['시리얼·그래놀라', '유제품·대체유'], ideas: [
  ...
  { id: 'lunch', time: '12:00', minute: 720, label: '점심', note: '든든하게 채우는 점심', categories: ['도시락·간편식'], ideas: [
  ...
  { id: 'afternoon', time: '15:00', minute: 900, label: '오후 간식', note: '잠시 쉬어가는 티타임', categories: ['프로틴바·건강간식', '견과·건과류'], ideas: [
  ...
  { id: 'evening', time: '18:01', minute: 1081, label: '저녁', note: '하루를 마무리하는 식탁', categories: ['닭가슴살·고단백 식품'], ideas: [
